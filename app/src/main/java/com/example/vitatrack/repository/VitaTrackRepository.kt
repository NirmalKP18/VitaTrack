...
class VitaTrackRepository(
    ...
    suspend fun updateEmail(email: String) = userSettingsDao.updateEmail(email)
    suspend fun updateProfileImage(uri: String) = userSettingsDao.updateProfileImage(uri)
    suspend fun updateBio(bio: String) = userSettingsDao.updateBio(bio)
